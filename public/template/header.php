...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo SITE_URL; ?>assets/img/icons/android/android-launchericon-48-48.png" />
	...
	<!-- <script>
		window.onload = function() {
			if ("serviceWorker" in navigator) {
				console.log("%cService Worker :" + "%cStart", 'color: #ff0062; font-size: 15px', 'color: #221628');

				if (navigator.serviceWorker.controller) {
					console.log(
						"%cStatus : " + "%c Already Activeted", 'color: #ff0062; font-size: 15px', 'color: #221628'
					);
					console.log("%cState : " + "%c" + navigator.serviceWorker.controller.state, 'color: #ff0062; font-size: 15px', 'color: #221628; text-transform: capitalize;');
					console.log("%cScript Url : " + navigator.serviceWorker.controller.scriptURL, "color: #ff0062; font-size: 15px");
				} else {
					...
					navigator.serviceWorker
						...
						.then(function(reg) {
							console.log(
								"%cService Worker: ",
								"%cRegister Successfully on Scope",
								reg.scope,
								"color: #ff0062; font-size: 15px",
								"color: #221628"
							);
						});
				}
	...
	elseif (check_current_method_similar('add') or check_current_method_similar('edit')) : ?>
		...
		<link href="<?php echo SITE_URL; ?>assets/css/components/tabs-accordian/custom-accordions.css" rel="stylesheet" type="text/css" />
	...
	<div id="load_screen">
		<div class="loader">
			<div class="loader-content">
				<img src="<?php echo SITE_URL; ?>assets/img/loader.gif" alt="<?php echo SITE_NAME; ?> is Loading...">
			</div>
		</div>
	</div>
	<!--  END LOADER -->
						...
						<div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
							<div class="user-profile-section">
								<div class="media mx-auto">
									<?php if (is($_SESSION['USER_PIC'])) : ?>
										<img src="<?php is($_SESSION['USER_PIC'], 'show'); ?>" class="img-fluid mr-2" alt="<?php is($_SESSION['USER_NAME'], 'show'); ?>">
									<?php endif; ?>
									<div class="media-body">
										<h5>
											<?php strlen($_SESSION['USER_FULLNAME']) <= 8 and print ($_SESSION['USER_FULLNAME']) or print($_SESSION['USER_NAME']); ?>
										</h5>
										<?php if ($_SESSION['USER_TYPE'] === 'ADMIN') : ?>
											<p>
												<?php is($_SESSION['USER_ROLE_NAME'], 'showCapital'); ?>
											</p>
										<?php endif; ?>
									</div>
								</div>
							...
							<a class="dropdown-item" href="auth_lockscreen.html">
