...
hideDropdown( '.user-profile-dropdown, .message-dropdown, .notification-dropdown', '.user-profile-dropdown .dropdown-menu, .message-dropdown .dropdown-menu, .notification-dropdown .dropdown-menu', 'show' );